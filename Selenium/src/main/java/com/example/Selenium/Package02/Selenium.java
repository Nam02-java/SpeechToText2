...
public class Selenium extends TelegramLongPollingBot implements Runnable {
    ...
    protected final int limitChar = 20;
    ...
    public ResponseEntity<?> Direction() throws InterruptedException, IOException, TelegramApiException {
...
class kao {
    public static void main(String[] args) throws TelegramApiException, IOException, InterruptedException {
        ...
        telegramBotsApi.registerBot(selenium);
        selenium.Direction();
    }
}